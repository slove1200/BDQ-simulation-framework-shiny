      ...
      card(
        ...
        card_body(
          ...
          numericInput("REP", 
            ...
            value = 1, min = 1, max = 3, 
            width = "100%"),
          tags$span("The minimum value is 1 and maximum value is 3",
          ...
          numericInput("simtime", 
            ...
            width = "100%"),
          tags$span("The simulation inverval for PK and safety is every hour. For efficacy the scheduled visit is assumed to be every week",
          style = "font-size: 10px; margin-top: -20px;"),
          ...
          numericInput("simtimeMSM", 
            ...
            width = "100%"),
          tags$span("The simulation inverval for long-term outcome is every week",
          style = "font-size: 10px; margin-top: -20px;"),
