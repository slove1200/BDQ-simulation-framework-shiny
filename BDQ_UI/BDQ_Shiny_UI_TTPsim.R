      ...
      card(
        ...
        card_body(
          numericInput("nsim_TTP", 
                      label = tags$span(style="font-size: 13px; font-weight: bold;", "Numbers of Subjects"), 
          ...
          numericInput("REP_TTP", 
                      label = tags$span(style="font-size: 13px; font-weight: bold;", "Numbers of Culture Replicates per Sampling Timepoint"), 
                      value = 1, min = 1, max = 3, 
                      width = "70%"), 
