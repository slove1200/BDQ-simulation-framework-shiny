                ...
                column(6,
                       card(
                         ...
                         card_body(
                           ...
                           numericInput("CACOR", 
                             label = tags$span(style="font-size: 13px; font-weight: bold;", "Baseline Corrected Calcium Level (mmol/L)"), 
                             value = 2.44, min = 0.1, max = 20, step = 0.01),
                           numericInput("K", 
                             label = tags$span(style="font-size: 13px; font-weight: bold;", "Baseline Potassium Level (mmol/L)"), 
